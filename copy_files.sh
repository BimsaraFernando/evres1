# ./sashi_release.sh v3.5.14 main kavindu74
#curl -fsSL https://github.com/du1ana/evres1/releases/download/sashi_v3.5.14/setup.sh | cat | sudo SKIP_SYSREQ=1 NO_DOMAIN=1 NETWORK=devnet bash -s install
#!/bin/bash
