# ./sashi_release.sh v3.6.9 main kavindu109
#curl -fsSL https://github.com/BimsaraFernando/evres1/releases/download/sashi_v3.6.9/setup.sh | cat | sudo SKIP_SYSREQ=1 NO_DOMAIN=1 NETWORK=devnet bash -s install
#!/bin/bash
